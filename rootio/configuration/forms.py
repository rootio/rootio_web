...
class VoicePromptForm(Form):
    ...
    call_end = FileField(_('Your call will end in'))
    call_end_part2 = FileField(_('seconds'))
    ...
    call_queued = FileField(_('Call from community caller { caller number }'))
    call_queued_part2 = FileField(_('was queued'))
    call_failed = FileField(_('The call to { number }'))
    call_failed_part2 = FileField(_('failed. Please pres the hash key to try again'))
    ...
    call_end_txt = TextField(_('Your call will end in (text)'))
    call_end_part2_txt = TextField(_('seconds (text)'))
    ...
    call_queued_txt = TextField(_('Call from community caller { caller number } (text)'))
    call_queued_part2_txt = TextField(_('was queued (text)'))
    call_failed_txt = TextField(_('The call to { number } (text)'))
    call_failed_part2_txt = TextField(_('failed. Please pres the hash key to try again (text)'))
